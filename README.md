# Fuzzing of [Robot-Framework-Solidity-Testing-Toolkit](https://github.com/jg8481/Robot-Framework-Solidity-Testing-Toolkit)

This is a work-in-progress fork of patrickd's original "[solidity-fuzzing-boilerplate](https://github.com/patrickd-/solidity-fuzzing-boilerplate)" that is being re-designed to be used with the [Robot-Framework-Solidity-Testing-Toolkit](https://github.com/jg8481/Robot-Framework-Solidity-Testing-Toolkit). The new `run-solidity-fuzz-tests.sh` included in this repo can also be used as a standalone fuzz testing script, but it's designed to be used from a MacOS machine (could work on Linux too with minor changes). 
